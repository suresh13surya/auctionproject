                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class='list-group' id='cat-list'>
                            <li class='list-group-item' data-id='all' data-href="index.php?page=auction&category_id=all">All</li>
                            <?php
                                $cat = $conn->query("SELECT * FROM categories order by name asc");
                                while($row=$cat->fetch_assoc()):
                                    $cat_arr[$row['id']] = $row['name'];
                             ?>
                            <li class='list-group-item' data-id='<?php echo $row['id'] ?>' data-href="index.php?page=auction&category_id=<?php echo $row['id'] ?>"><?php echo ucwords($row['name']) ?></li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
                                ...
                                if($cat->num_rows <= 0){
                                    echo "<center><h4><i>NO AUCTION TODAY</i></h4></center>";
                                } 
                                while($row=$cat->fetch_assoc()):
                             ?>
                             <div class="col-sm-4">
